...
class SystemMovilColors {
  ...
  // Color secundario - Verde menta (accesorios, detalles)
  ...
  // Color de éxito - Verde más intenso para confirmaciones
  ...
  static const Color outline = Color(0xFFD1D5DB); // Borde suave
